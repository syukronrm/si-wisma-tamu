...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">     
    ...
    <div class="row" style="padding-top:20px;">
      ...
      <div class="panel panel-default" >
        ...
        <h3 align="center">DATA JENIS KAMAR</h3>
        <?php
          ...
          <tbody>
           <?php
              ...
              {?>
                ...
                <td>
                  <div>
                    <form method="POST" action="update-jenis-kamar.php">
                      <center>
                        <button type="submit" class="btn btn-primary">Edit</button>
                        <input type="hidden" name="update_jenis" value="<?php echo $row['ID_JENIS'];?>"> </input>
                      </center>
                    </form>
                  </div>
                </td>
       ...
       <div>
           <?php
              ...
              {
                $idjenis = $_GET['del_jenis'];
                echo '
                   <form method="POST" action="delete-jenis-kamar.php">
                    <div class="controls" style="display:none;">
                      <input class="form-control" type="text" name="id_jenis" value="'.$idjenis.'">
                    </div>
